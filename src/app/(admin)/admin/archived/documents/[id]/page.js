...
const ArchivedDocumentView = ({params}) => {
    ...
    return (
        <>
            <div className="border-b mb-8">
                <h1 className="text-3xl text-[#002855] font-light pb-5">Archived Document Library Details</h1>
            </div>
            <div className="flex justify-start text-center">
                <Link href={`/admin/archived/documents`} className="w-44 py-2 px-6 bg-primary flex items-center justify-center font-medium">Back</Link>
            </div>
            <div className="mt-6">
                <div className='flex'>
