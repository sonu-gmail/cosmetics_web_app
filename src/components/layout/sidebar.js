                ...
                <div className="py-7">
                    <ul>
                        ...
                        <li onClick={() => handleMenu('issueTracker')}>
                            ...
                            <ul className={ (issueTracker == false) ? 'hidden' : ''}>
                                {
                                    issueTrackerListing.map((issueTracker, index) => (
                                        <li key={index} className="text-white py-2 px-3 uppercase text-xs hover:text-opacity-45 hover:bg-[#002044]">
                        ...
                        <li className="text-[#44b4a6] py-3 px-3 uppercase text-base hover:text-opacity-45 hover:bg-[#002044]">
                        ...
                        <li className="text-[#44b4a6] py-3 px-3 uppercase text-base hover:text-opacity-45 hover:bg-[#002044]">
                            <Link href="/admin">Commitee Meetings</Link>
                        </li>
                        <li  onClick={() => handleMenu('archived')}>
                            ...
                            <ul className={ (archivedMenu == false) ? 'hidden' : ''}>
                                <li className="text-white py-2 px-3 uppercase text-xs hover:text-opacity-45 hover:bg-[#002044]">
                                    <Link href="/admin" className="flex items-center"><FaCaretRight/>Issue Tracker</Link>
                                </li>
                                <li className="text-white py-2 px-3 uppercase text-xs hover:text-opacity-45 hover:bg-[#002044]">
                                    <Link href="/admin" className="flex items-center"><FaCaretRight/>Documents</Link>
                                </li>
                            </ul>
                        </li>
                    </ul>
